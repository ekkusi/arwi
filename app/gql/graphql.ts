...
export type GroupListItemFragment = { __typename?: 'Group', id: string, name: string, subject: { __typename?: 'Subject', label: string, code: string } } & { ' $fragmentName'?: 'GroupListItemFragment' };
...
export type MainPage_GetTeacherQuery = { __typename?: 'Query', getTeacher: { __typename?: 'Teacher', email: string, id: string, groups: Array<{ __typename?: 'Group', id: string, name: string, subject: { __typename?: 'Subject', label: string, code: string } }> } };
