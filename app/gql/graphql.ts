...
type EvaluationsAccordion_Evaluation_ClassParticipationEvaluation_Fragment = { __typename: 'ClassParticipationEvaluation', behaviourRating?: number | null, skillsRating?: number | null, id: string, notes?: string | null, wasPresent: boolean, collection: { __typename?: 'ClassParticipationCollection', date: string, environment: { __typename?: 'Environment', code: string, color: string, label: { __typename?: 'TranslatedString', fi: string } } }, student: { __typename?: 'Student', name: string } } & { ' $fragmentName'?: 'EvaluationsAccordion_Evaluation_ClassParticipationEvaluation_Fragment' };

type EvaluationsAccordion_Evaluation_DefaultEvaluation_Fragment = { __typename: 'DefaultEvaluation', rating?: number | null, id: string, notes?: string | null, wasPresent: boolean, collection: { __typename?: 'DefaultCollection', date: string }, student: { __typename?: 'Student', name: string } } & { ' $fragmentName'?: 'EvaluationsAccordion_Evaluation_DefaultEvaluation_Fragment' };

export type EvaluationsAccordion_EvaluationFragment = EvaluationsAccordion_Evaluation_ClassParticipationEvaluation_Fragment | EvaluationsAccordion_Evaluation_DefaultEvaluation_Fragment;
...
export type CollectionPage_GetCollectionQuery = { __typename?: 'Query', getCollection: { __typename: 'ClassParticipationCollection', id: string, date: string, description?: string | null, environment: { __typename?: 'Environment', code: string, color: string, label: { __typename?: 'TranslatedString', fi: string } }, learningObjectives: Array<{ __typename?: 'LearningObjective', code: string, label: { __typename?: 'TranslatedString', fi: string } }>, module: { __typename?: 'Module', group: { __typename?: 'Group', name: string, id: string } }, evaluations: Array<(
      ...
      & { ' $fragmentRefs'?: { 'EvaluationsAccordion_Evaluation_ClassParticipationEvaluation_Fragment': EvaluationsAccordion_Evaluation_ClassParticipationEvaluation_Fragment } }
    )> } | { __typename: 'DefaultCollection', id: string, date: string, description?: string | null, module: { __typename?: 'Module', group: { __typename?: 'Group', name: string, id: string } }, evaluations: Array<(
      { __typename?: 'DefaultEvaluation', id: string }
      & { ' $fragmentRefs'?: { 'EvaluationsAccordion_Evaluation_DefaultEvaluation_Fragment': EvaluationsAccordion_Evaluation_DefaultEvaluation_Fragment } }
    )> } };
...
export type StudentPage_GetStudentQuery = { __typename?: 'Query', getStudent: { __typename?: 'Student', id: string, name: string, group: { __typename?: 'Group', id: string, name: string, subject: { __typename?: 'Subject', code: string, label: { __typename?: 'TranslatedString', fi: string } }, currentModule: { __typename?: 'Module', id: string, info: { __typename?: 'ModuleInfo', educationLevel: EducationLevel, learningObjectiveGroupKey: string, label: { __typename?: 'TranslatedString', fi: string } } } }, currentModuleEvaluations: Array<(
      ...
      & { ' $fragmentRefs'?: { 'EvaluationsAccordion_Evaluation_ClassParticipationEvaluation_Fragment': EvaluationsAccordion_Evaluation_ClassParticipationEvaluation_Fragment;'EvaluationsLineChart_EvaluationFragment': EvaluationsLineChart_EvaluationFragment;'EvaluationsBarChart_EvaluationFragment': EvaluationsBarChart_EvaluationFragment } }
