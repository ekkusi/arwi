...
-- AddForeignKey
ALTER TABLE "EvaluationCollection" ADD CONSTRAINT "classParticipationCollection_collectionDataId" FOREIGN KEY ("collectionDataId") REFERENCES "ClassParticipationCollectionData"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "EvaluationCollection" ADD CONSTRAINT "defaultCollection_collectionDataId" FOREIGN KEY ("collectionDataId") REFERENCES "DefaultCollectionData"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
