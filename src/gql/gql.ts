...
const documents = {
  ...
  "\n  fragment ClassYearSelect_ClassYearInfo on ClassYearInfo {\n    code\n    label\n  }\n":
    types.ClassYearSelect_ClassYearInfoFragmentDoc,
  ...
  "\n  fragment SubjectSelect_Subject on Subject {\n    code\n    label\n  }\n":
    types.SubjectSelect_SubjectFragmentDoc,
  ...
  "\n  fragment EnvironmentSelect_Environment on Environment {\n    code\n    label\n    color\n  }\n":
    types.EnvironmentSelect_EnvironmentFragmentDoc,
  ...
  "\n  query CreateGroupPage_GetMetaData {\n    getSubjects {\n      ...SubjectSelect_Subject\n    }\n    getYearInfos {\n      ...ClassYearSelect_ClassYearInfo\n    }\n  }\n":
    types.CreateGroupPage_GetMetaDataDocument,
