...
export type ClassOverviewPage_QueryQuery = {
  __typename?: "Query";
  class?: {
    __typename?: "Class";
    name: string;
...
export type MainPage_QueryQuery = {
  __typename?: "Query";
  teacher?: {
    __typename?: "Teacher";
    email: any;
    ...
    class?: {
      ...
      edges?: Array<{
        __typename?: "ClassEdge";
        node: { __typename?: "Class"; name: string };
      } | null> | null;
    } | null;
  } | null;
};
...
export type Register_RegisterTeacherMutationVariables = Exact<{
  name: Scalars["String"];
  email: Scalars["Email"];
  passwordHash: Scalars["String"];
}>;

export type Register_RegisterTeacherMutation = {
  __typename?: "Mutation";
  teacherCreate?: {
    __typename?: "TeacherCreatePayload";
    teacher?: {
...
export type Register_GetTeacherQueryVariables = Exact<{
  email: Scalars["Email"];
}>;

export type Register_GetTeacherQuery = {
  __typename?: "Query";
  teacher?: {
    __typename?: "Teacher";
    email: any;
...
export const ClassOverviewPage_QueryDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "ClassOverviewPage_Query" },
      variableDefinitions: [
        {
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "MainPage_Query" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
...
} as unknown as DocumentNode<MainPage_QueryQuery, MainPage_QueryQueryVariables>;
...
>;
export const Register_RegisterTeacherDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "Register_RegisterTeacher" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "name" } },
  ...
  Register_RegisterTeacherMutationVariables
>;
export const Register_GetTeacherDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "Register_GetTeacher" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
  ...
  Register_GetTeacherQueryVariables
>;
